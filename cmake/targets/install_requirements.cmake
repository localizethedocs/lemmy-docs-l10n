...
message(STATUS "Running 'cargo install' command to requirements...")
if (CMAKE_HOST_LINUX)
...
if     (VERSION_OF_MDBOOK STREQUAL "[none]")
    set(CRATE_OF_MDBOOK "")
elseif (VERSION_OF_MDBOOK STREQUAL "")
    set(CRATE_OF_MDBOOK "mdbook")
else()
    set(CRATE_OF_MDBOOK "mdbook@${VERSION_OF_MDBOOK}")
endif()
if     (VERSION_OF_MDBOOK_I18N_HELPERS STREQUAL "[none]")
    set(CRATE_OF_MDBOOK_I18N_HELPERS "")
elseif (VERSION_OF_MDBOOK_I18N_HELPERS STREQUAL "")
